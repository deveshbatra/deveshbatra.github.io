export const profile = {
  ...
  shortBio:
    "Devesh Batra is an AI researcher and data scientist working on applied machine learning, LLM systems, AI governance, and decision-making under uncertainty.",
  personalLine:
...
export const researchThemes = [
  "LLM systems in finance and banking",
  "Responsible AI, governance, and evaluation",
  "Uncertainty, conformal prediction, and decision systems",
  "Model behaviour, bias, risk, and human-AI interaction"
];
